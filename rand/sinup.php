...
if (isset($_POST['BTNsend'])) {
    if (
        ...
        if ($count > 0) {
            ...
            VALUES 
            ('$full_baby_name', '$uName', '$pass', '$date_of_birth', '$baby_gender', '$The_language_you_want_to_learn', '$language_speaking_level', '$studied_it_before', '$language_study_level', '$Father_name', '$mother_name', '$supervisor', '$email', '$Telephone', '$country', '$current_residence', '$current_residential_address', '$message_question')
            ";
