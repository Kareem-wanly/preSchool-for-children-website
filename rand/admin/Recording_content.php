...
?>
    <div class="sec-title">
        ...
        <a href="category.php?box=record">Add a new category</a>
    </div>
            ...
            ?>
                <div class="card-container">
                    ...
                    <div class="btn">
                        ...
                        <a href='View_record.php?Class_ID=<?php echo $row['Class_ID'] ?>' class="btn btn-warning">View</a>
            ...
            if (
                ...
                if (in_array($fileType, $allowTypes)) {
                    ...
                    if ($conn->query($query) === TRUE) {
                        ...
                        header('REFRESH:2;URL=Recording_content.php');
                    } else {
                        echo $conn->error;
                    }
                } else {
